...
def plot_shap_single_waterfall(model, silent, q, param_name):
...
def plot_shap_multiple_waterfalls(model, silent, q, param_name=None, show_param_values=False):
...
def plot_shap_beeswarm(model, silent, param_name, q=None):
